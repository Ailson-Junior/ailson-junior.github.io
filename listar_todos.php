...
<head>
    ...
    <title>Bom Jardim - Todos os Membros</title>
...
<body style="background-color: lightsteelblue;">
    ...
    <?php
        if($busca->num_rows > 0)
        {
            while($resultado = $busca->fetch_assoc())
            {
                echo "<center><table>
                      ...
                      <br>";?>
                      <input type='hidden' name='idMembro' value='<?php echo $resultado["Id"] ?>'/>
        ...
        {
            echo "<h1 style='text-align:center;'>Nenhum membro cadastrado!</h1>";
        }
