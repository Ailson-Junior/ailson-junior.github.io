...
$situacaoMembro = $_POST["situacaoMembro"];

$sql = "SELECT * from membros WHERE Situacao = '$situacaoMembro'";
...
<head>
    ...
    <title>Bom Jardim - Buscar por Situação</title>
...
<body style="background-color: lightsteelblue;">
    ...
    <?php
        ...
        {
            echo "<h1 style='text-align:center;'>Nenhum membro com esta situação!</h1>";
        }
