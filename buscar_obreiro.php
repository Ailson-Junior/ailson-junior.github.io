...
$funcaoObreiro = $_POST["funcaoMembro"];

$sql = "SELECT * from membros WHERE FuncaoObreiro = '$funcaoMembro'";
...
<body style="background-color: lightsteelblue;">
    ...
    <?php
        ...
        {
            echo "<h1 style='text-align:center;'>Nenhum obreiro com esta função!</h1>";
        }
